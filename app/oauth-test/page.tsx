  ...
  return (
    <div style={{
      ...
      <div style={cardStyle}>
        ...
        {/* Step Guide */}
        <div style={{ background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "1rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          <p style={{ color: "#6b7db3", fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", margin: 0 }}>How It Works</p>
          {[
            { step: "1", text: "Enter your app's Client ID and Client Secret below" },
            { step: "2", text: "Click \"Run Test\" — you'll be shown an Orbit consent screen" },
            { step: "3", text: "Click \"Allow Access\" to approve" },
            { step: "4", text: "View the full profile JSON returned by Orbit Station" },
          ].map(item => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.375rem" }}>
            ...
            <input
              ...
              autoComplete="off"
            />
            <p style={{ color: "#4b5675", fontSize: "0.75rem", margin: 0 }}>
              ⚠️ This is a developer tool. Never share your Client Secret publicly.
            </p>
          </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1rem" }}>
          <p style={{ color: "#4b5675", fontSize: "0.7rem", textAlign: "center", margin: 0 }}>
            This page is only intended for developers. The callback URL used in this test is{" "}
            <code style={{ color: "#6b7db3", background: "rgba(0,0,0,0.3)", padding: "1px 5px", borderRadius: "4px", fontSize: "0.7rem" }}>
              {typeof window !== "undefined" ? `${window.location.origin}/api/oauth/test-callback` : "/api/oauth/test-callback"}
            </code>
            <br />
            Make sure this URI is registered in your OAuth App&apos;s Redirect URIs.
          </p>
        </div>
      </div>
    </div>
