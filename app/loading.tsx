...
export default function Loading() {
  return (
    <div
      id="warp-loader"
      className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-md pointer-events-none transform translate-z-0"
    >
      ...
      <div className="relative w-32 h-32 flex items-center justify-center z-10">
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5 bg-blue-500 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.8)]">
            {/* Moon for Planet 1 */}
            <div
              className="absolute w-8 h-8 -top-1.5 -left-1.5 animate-spin"
              style={{
