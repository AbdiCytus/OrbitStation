...
const AnalyticsResponse: Token[][] = [
  ...
  [{ type: "plain", text: "  " }, { type: "key", text: '"success"' }, { type: "plain", text: ": " }, { type: "bool", text: "true" }, { type: "plain", text: "," }],
  [{ type: "plain", text: "  " }, { type: "key", text: '"data"' }, { type: "plain", text: ": {" }],
  [{ type: "plain", text: "    " }, { type: "key", text: '"totalStationVisits"' }, { type: "plain", text: ": " }, { type: "number", text: "100" }, { type: "plain", text: "," }],
  [{ type: "plain", text: "    " }, { type: "key", text: '"uniqueVisitors"' }, { type: "plain", text: ": " }, { type: "number", text: "50" }, { type: "plain", text: "," }],
  [{ type: "plain", text: "    " }, { type: "key", text: '"beaconsClicked"' }, { type: "plain", text: ": " }, { type: "number", text: "200" }, { type: "plain", text: "," }],
  [{ type: "plain", text: "    " }, { type: "key", text: '"topBeacons"' }, { type: "plain", text: ": [" }],
  [{ type: "plain", text: "      {" }],
  [{ type: "plain", text: "        " }, { type: "key", text: '"title"' }, { type: "plain", text: ": " }, { type: "string", text: '"GitHub"' }, { type: "plain", text: "," }],
  [{ type: "plain", text: "        " }, { type: "key", text: '"clicks"' }, { type: "plain", text: ": " }, { type: "number", text: "150" }],
  [{ type: "plain", text: "      }" }],
  [{ type: "plain", text: "    ]" }],
  [{ type: "plain", text: "  }" }],
  [{ type: "plain", text: "}" }],
